...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GoogleMapsBase",
            url: "https://github.com/jurajantas/GoogleMapsBase/releases/download/7.4.0/GoogleMapsBase.xcframework.zip",
            checksum: "3f43aa4c7d70f6fecac33519009c66b478e64fe7304db7dd801488a7819bf3e5"),
        .binaryTarget(
            name: "GoogleMapsCore",
            url: "https://github.com/jurajantas/GoogleMapsCore/releases/download/7.4.0/GoogleMapsCore.xcframework.zip",
